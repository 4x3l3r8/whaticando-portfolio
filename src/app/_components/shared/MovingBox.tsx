...
const RollingImage = () => {
    return (
        <Box as={motion.div} border="1px solid white" w={528} h={528} rounded={"40% 60% 70% 30% / 40% 50% 60% 50%"} animation={`${animation}`} transitionDelay={"3s"}>
            <Box as={motion.div} bg={"primary.200"} pos={"relative"} w={528} h={528} rounded={"40% 60% 70% 30% / 40% 50% 60% 50%"} overflow={"hidden"} animation={animation}>
                {/* asdfasd */}
                <Image h={"100%"} src="https://github.com/4x3l3r8.png" />
            </Box>
        </Box>
    )
}
